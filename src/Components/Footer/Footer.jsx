...
<div className='flex justify-center items-center '>
    <h1 className='text-[1.9rem] designer'>Copyright 2023 <span className='text-[#46d983]'>DRIVCO </span>| Design By <span className='text-[#46d983]'> Egens Lab</span></h1>
...
<h1 className='text-[1.9rem] designer'>Follow Us On :</h1>
