...
const Card = (props) => {
  return (
<div className="w-[31rem] cards-container text-[1.7rem] bg-white rounded-3xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
      {/* Header badges */}
      ...
      <div className="p-6 space-y-4">
        <div className="space-y-2">
          <p className="text-red-500 font-medium">{props.model}</p>
        ...
        {/* Price */}
        <p className="text-3xl font-bold text-[black]">{props.price}</p>
        ...
        <div className="flex items-center justify-between pt-4">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-medium text-gray-700 text-2xl">{props.owner}</span>
          </div>
          <button className="relative px-6 py-2 border-2 text-black border-red-500 rounded-full text-2xl overflow-hidden group">
